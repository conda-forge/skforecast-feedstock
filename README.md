...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/skforecast-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/skforecast-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install skforecast
```
...
It is possible to list all of the versions of `skforecast` available on your platform:
...
```
pixi search skforecast --channel conda-forge
```
